...
**Attention!** This library is entirely rewritten to work with `react-window`. If you are looking for the tree view solution for [react-virtualized](https://github.com/bvaughn/react-virtualized), take a look at [react-virtualized-tree](https://github.com/diogofcunha/react-virtualized-tree).
